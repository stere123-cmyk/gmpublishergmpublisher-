...
SWEP.Primary.Sound = Sound("trb_prism_m7_rifle_fire")
...
SWEP.Recoil = {
    Vertical = { 2, 2 }, Horizonal = { -0.3, 0.3 },
    AdsMultiplier = 0.1, KickDown = 1, Shake = 0.8
}
SWEP.VisualRecoil = {
    Vertical = { 1, 1 }, Horizonal = { -0.1, 0.1 },
    Backward = { 0.1, 0.1, 1 }, RecoverSpeed = 0.1, RecoverDelay = 0.1, AdsMultiplier = 1
}
SWEP.Spread = {
    Base = 0.009, Vertical = 1.0, Horizontal = 1.0,
    Max = 0.2, Increase = 0.01, Recover = 0.3, Delay = 0.1
}
...
SWEP.Animations = {
    ...
    ["Reload"] = {
        ...
        Length = 1,
        events = {
            { time = 0.2, callback = function(self) self:EmitSound("weapons/rifle/gunother/rifle_clip_out_1.wav") end },
            { time = 0.5, callback = function(self) self:MagzineLoaded() end },
            { time = 0.6, callback = function(self) self:EmitSound("weapons/rifle/gunother/rifle_clip_in_1.wav") end }
        }
    },
    ["Reload_Empty"] = {
